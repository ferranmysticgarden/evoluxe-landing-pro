        ...
        <div className="prose prose-slate max-w-none space-y-6 text-muted-foreground">
          <section>
            ...
            <p className="mt-4">
              ...
              <strong>Correo electrónico:</strong> fcanamases@gmail.com
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              Para ejercer estos derechos, puede contactarnos en: fcanamases@gmail.com o llamando al +34 609 955 494
            </p>
          </section>
